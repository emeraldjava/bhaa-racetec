...
case
	when t2.TotalStd between 1 and 32 then 'A'
	when t2.TotalStd between 33 and 38 then 'B'
	when t2.TotalStd between 39 and 45 then 'C'
	when t2.TotalStd between 46 and 90 then 'D' end as Class
